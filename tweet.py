...
bot = Client("OdinGame_Tweet",api_id,api_hash,bot_token=bot_token)
...
async def panel(c,m):
	await bot.send_message(m.chat.id,f"**• بخش مورد نظرتون رو انتخاب کنین **",reply_markup=await odingame(),reply_to_message_id=m.message_id)
